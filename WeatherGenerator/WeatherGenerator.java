...
public class WeatherGenerator {
    ...
    public static void populateLocationProbabilities( double[] drywetProbability, double[] wetwetProbability, 
        ...
        for(int i = 0; i < 12; i++){
            ...
            wetwetProbability[i] = wetwet[n][i + 2];
        }
    }
    ...
    double random = 0;
    int firstday;
    int[] n = new int[numberOfDays];
    double day1 = StdRandom.uniform();
    
    if(day1 < .50){   // 50% 50% if first day is dry or wet
        firstday = WET;
    }
    else{
        firstday = DRY;
    }
    n[0] = firstday;  // determines that first day is dry or wet
...
//         random = StdRandom.uniform();
//        if(i == 0){
//         if(random < 0.5){  //checks if day 1 will be wet
//             n[i] = WET;
//         }
//         if(random > 0.5){  // checks if day 1 will be dry
//             n[i] = DRY;
//         }
//     }
// }
...
// random being less than or equal to wetwetProbability means itll be a wet day
    ...
    public static void main (String[] args) {
        StdRandom.setSeed(1668142980482L);
